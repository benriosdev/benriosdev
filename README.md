...
| **Base de datos de Estudiantes** | Proyecto de BD relacional: diseño de tablas, relaciones y modelo E-R | `SQL` `Educativo` | <a href="https://benrios.dev/modelo-er/"><img src="./buttons/ver-modelo.svg" alt="Ver modelo ER"></a> |
...
| **Piedra, Papel o Tijera** | Juego clásico en Java con lógica de partida y puntuación en tiempo real | `Java` `Educativo` | <a href="https://benrios.dev/piedra-papel-tijera-java/"><img src="./buttons/jugar.svg" alt="Jugar"></a> |
