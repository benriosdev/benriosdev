...
<p align="center"><a href="https://benrios.dev"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/portfolio-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/portfolio.svg"><img src="./buttons/portfolio.svg" width="200" alt="Portfolio"></picture></a>&nbsp;&nbsp;&nbsp;<a href="https://www.linkedin.com/in/benriosdev/"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/linkedin-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/linkedin.svg"><img src="./buttons/linkedin.svg" width="200" alt="LinkedIn"></picture></a>&nbsp;&nbsp;&nbsp;<a href="https://benrios.dev/faq/#contacto"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/email-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/email.svg"><img src="./buttons/email.svg" width="200" alt="Email"></picture></a></p>
...
|:---|:---|:---|:---:|
| **Aprendiendo Git y GitHub** | Guía completa de control de versiones, repos y colaboración. | `Git` `GitHub` | <a href="https://benrios.dev/hola-git/git/"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/guia-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/guia.svg"><img src="./buttons/guia.svg" width="120" alt="Abrir guía"></picture></a> |
| **Base de datos de Estudiantes** | Proyecto de BD relacional: diseño de tablas, relaciones y modelo E-R. | `BBDD` `Guía` | <a href="https://benrios.dev/modelo-er/"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/modelo-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/modelo.svg"><img src="./buttons/modelo.svg" width="120" alt="Ver modelo ER"></picture></a> |
| **Java Fundamentos Básicos** | App educativa para aprender Java desde cero con ejercicios interactivos. | `Java` `Educativo` | <a href="https://benrios.dev/fundamentos-java/"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/proyecto-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/proyecto.svg"><img src="./buttons/proyecto.svg" width="120" alt="Ver proyecto"></picture></a> |
| **Guía interactiva de JavaScript** | Guía de fundamentos de JS, desde variables hasta el DOM y eventos. | `JavaScript` `HTML` `CSS` | <a href="https://benrios.dev/javascript/"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/aprender-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/aprender.svg"><img src="./buttons/aprender.svg" width="120" alt="Aprender"></picture></a> |
| **Piedra, Papel o Tijera** | PAC de desarrollo de DAW. Juego clásico en Java con lógica de partida y puntuación. | `Java` `Ejercicios` | <a href="https://benrios.dev/piedra-papel-tijera-java/"><picture><source media="(prefers-color-scheme: dark)" srcset="./buttons/jugar-dark.svg"><source media="(prefers-color-scheme: light)" srcset="./buttons/jugar.svg"><img src="./buttons/jugar.svg" width="120" alt="Jugar"></picture></a> |
